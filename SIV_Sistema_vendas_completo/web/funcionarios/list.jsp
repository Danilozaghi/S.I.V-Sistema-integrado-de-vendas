...
<div class="container">
  <div class="d-flex justify-content-between align-items-center mb-3">
    <h2>Funcionários</h2>
    <a href="<%=request.getContextPath()%>/funcionario-edit" class="btn btn-primary">Novo Funcionário</a>
  </div>
        ...
        <td>
          <% if (f.getImagem() != null && !f.getImagem().isEmpty()) { %>
            <img src="<%=request.getContextPath()%>/<%=f.getImagem()%>"
                 alt="Foto" style="width:60px;height:60px;object-fit:cover;border-radius:50%;">
          <% } else { %>
            -
          <% } %>
        </td>
  ...
  <a href="<%=request.getContextPath()%>/dashboard.jsp" class="btn btn-link">Voltar</a>
</div>
</body>
</html>
