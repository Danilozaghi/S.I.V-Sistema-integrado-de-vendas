...
<%
    ...
    for (Estoque e : lista) {
        ...
        if ("ENTRADA".equalsIgnoreCase(e.getTipo())) {
            totalCompras += totalMov;
        } else if ("SAIDA".equalsIgnoreCase(e.getTipo())) {
...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/style_css/Estoque-Lista.css">
</head>
<body>
        ...
        <div class="card-body">
            ...
            <table class="tabela">
                ...
                <tr>
                    ...
                    <td>
                        <% if ("ENTRADA".equalsIgnoreCase(e.getTipo())) { %>
                            <span style="color:#ff4d4d; font-weight:600;">Compras</span>
                        <% } else if ("SAIDA".equalsIgnoreCase(e.getTipo())) { %>
                            <span style="color:#3be07a; font-weight:600;">Vendas</span>
                        <% } else { %>
                            <span><%=e.getTipo()%></span>
                        <% } %>
                    </td>
