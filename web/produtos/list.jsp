...
<head>
  ...
  <link rel="stylesheet" href="<%=request.getContextPath()%>/style_css/Produto-Lista.css">
</head>
<body class="p-4">
<div class="container">
  <div class="d-flex justify-content-between align-items-center mb-3">
    <h2>Produtos</h2>
    <div>
      <a href="<%=request.getContextPath()%>/produto-edit" class="btn btn-primary btn-sm">Novo Produto</a>
  ...
  <table class="tabela">
    ...
    <% for (Produto c : produtos) { %>
      <tr>
        ...
        <td><%=c.getEstoque()%></td>
        <td><%= c.getFornecedorNome() != null ? c.getFornecedorNome() : "—" %></td>
        <td>
          <a class="btn btn-sm btn-outline-secondary"
             href="<%=request.getContextPath()%>/produto-edit?id=<%=c.getId()%>">Editar</a>

          <a class="btn btn-sm btn-danger"
             href="<%=request.getContextPath()%>/produto-delete?id=<%=c.getId()%>"
